            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16">
                <Link href="/" className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-gray-900">Azure Pattern Demo Portal</h1>
                    <p className="text-xs text-gray-600">One-Click Architecture Deployment</p>
                  </div>
                </Link>
                <nav className="flex items-center gap-6">
                  <Link 
                    href="/" 
                    className="text-sm font-medium text-gray-700 hover:text-azure-600 transition-colors"
                  >
                    Patterns
                  </Link>
                  <a 
                    ...
                    className="text-sm font-medium text-gray-700 hover:text-azure-600 transition-colors flex items-center gap-1"
                  >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              <div className="text-center space-y-2">
                <p className="text-sm text-gray-600">
                  <strong>Disclaimer:</strong> These patterns are provided as educational examples. 
